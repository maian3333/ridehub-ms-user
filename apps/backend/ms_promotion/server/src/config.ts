...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8084';
  'jhipster.clientApp.name' = 'ms_promotion';
  ...
  'jhipster.mail.from' = 'ms_promotion@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'ms_promotion API';
  'jhipster.swagger.description' = 'ms_promotion API documentation';
  ...
  'eureka.instance.appname' = 'ms_promotion';
  'eureka.instance.instanceId' = 'ms_promotion:${random.value}';
  ...
  'cloud.config.name' = 'ms_promotion';
