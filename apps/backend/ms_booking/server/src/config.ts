...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8083';
  'jhipster.clientApp.name' = 'ms_booking';
  ...
  'jhipster.mail.from' = 'ms_booking@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'ms_booking API';
  'jhipster.swagger.description' = 'ms_booking API documentation';
  ...
  'eureka.instance.appname' = 'ms_booking';
  'eureka.instance.instanceId' = 'ms_booking:${random.value}';
