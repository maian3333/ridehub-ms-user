...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'ms_user';
  ...
  'jhipster.mail.from' = 'ms_user@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'ms_user API';
  'jhipster.swagger.description' = 'ms_user API documentation';
  ...
  'eureka.instance.appname' = 'ms_user';
  'eureka.instance.instanceId' = 'ms_user:${random.value}';
