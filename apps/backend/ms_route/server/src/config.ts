...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8082';
  'jhipster.clientApp.name' = 'ms_route';
  ...
  'jhipster.mail.from' = 'ms_route@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'ms_route API';
  'jhipster.swagger.description' = 'ms_route API documentation';
  ...
  'eureka.instance.appname' = 'ms_route';
  'eureka.instance.instanceId' = 'ms_route:${random.value}';
