...
import { ConditionLocationItemDTO } from './condition-location-item.dto';
import { PromotionDTO } from './promotion.dto';

/**
 * A ConditionByLocationDTO object.
 */
export class ConditionByLocationDTO extends BaseDTO {
  id?: number;
  ...
  @ApiProperty({ type: () => ConditionLocationItemDTO, isArray: true, description: 'items relationship' })
  items?: ConditionLocationItemDTO[];
